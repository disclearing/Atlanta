...
import xyz.invisraidinq.atlanta.scoreboard.event.BoardCreateEvent;
import xyz.invisraidinq.atlanta.scoreboard.provider.Board;
import xyz.invisraidinq.atlanta.scoreboard.provider.BoardAdapter;
import xyz.invisraidinq.atlanta.scoreboard.provider.BoardEntry;
...
public class Negox implements Listener
{
    ...
    private void run() {
        ...
        }.runTaskTimerAsynchronously((Plugin)this.plugin, 1L, this.ticks);
    }
